...
public abstract class GameObject {
    ...
    protected ID id;
    protected int vx, vy;
    protected Handler handler;// trong từng object lại có handler để tiện cho việc kiểm tra tương tác giữa object này và các object còn lại 
    ...
    public boolean canMoveR() {
        for (int i = 0; i < this.handler.object.size(); i++) {
            ...
            if (temp.getId() != ID.Wall && temp.getId() != ID.Wall2 && temp.getId() != ID.Bom) {// nếu là các đối tượng như bên trái thì k di chuyển đc
                continue;
            } else if (this.getId() == ID.Player) {// trừ trường hợp này
    ...
    public void removeits() {// để tự xóa nó ra khỏi danh sách handler
